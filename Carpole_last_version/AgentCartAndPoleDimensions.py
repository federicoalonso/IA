...
decrase_exploration_rate_factor = 50
...
for episode in range(episodes):
    ...
    if episode % save_every == 0:
        np.save(f"qtables/V6/{episode}-qtable.npy",Q)
    ...
    while not done and not truncated: 
        ...
        if truncated and not ever_finished:
...
np.save(f"qtables/V6/{episode}-qtable.npy",Q) #Para guardar el Q final
"""Graficar valores obtenidos de performance"""
